...
## [Unreleased][develop]
### Fixed
- Fixed a bug that could cause problems with headers/footers, and in particular an error with the `memoir` class. See [#1753](https://github.com/gregorio-project/gregorio/pull/1753).
