...
\begin{argtable}
  ...
  & \texttt{hphantom} & Notes are invisible with zero height, but horizontal spacing is preserved.\\
\end{argtable}
...
Controls whether NABC neumes skip leading alteration signs (flat, natural, sharp)
...
\begin{argtable}
  ...
  \#2 & \texttt{true} & Skip leading alterations; anchor neume to first square note.\\
...
\makeatletter
\def\getdims{%
  \edef\spaceabovelines{\gre@space@dimen@spaceabovelines}%
