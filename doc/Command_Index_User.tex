...
\begin{tabular}{lp{7cm plus .5cm}r}
  ...
  \stylename{nabc} & ancient notation (above staff) & {\color{gregoriocolor}gregoriocolor}\\
  \stylename{belowlinesnabc} & ancient notation (below staff) & {\color{gregoriocolor}gregoriocolor}\\
