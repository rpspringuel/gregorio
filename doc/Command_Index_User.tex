...
\begin{argtable}
  ...
  & \texttt{hphantom} & The staff lines are invisible with zero height, but horizontal spacing is preserved\\
\end{argtable}
...
\begin{argtable}
  ...
  & \texttt{hphantom} & Lyrics are invisible with zero height, but horizontal spacing is preserved.\\
\end{argtable}
...
\begin{argtable}
  ...
  & \texttt{hphantom} & Notes are invisible with zero height, but horizontal spacing is preserved. Useful for NABC with lyrics only.\\
\end{argtable}
...
\begin{argtable}
  ...
  & \texttt{hphantom} & Clefs are invisible with zero height, but horizontal spacing is preserved.\\
\end{argtable}
