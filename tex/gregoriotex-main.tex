...
\def\gre@typesettextabovelines#1#2{%
  ...
  \gre@dimen@temp@five=\dimexpr(\gre@space@dimen@spacebeneathtext
    + \gre@space@dimen@spacelinestext)\relax%
  % If notes/lines are visible or preserve height (phantom/vphantom), keep staffheight
  \ifgre@shownotes
    \advance\gre@dimen@temp@five by \gre@dimen@staffheight\relax
  \else\ifgre@showlines
    \advance\gre@dimen@temp@five by \gre@dimen@staffheight\relax
  \else\ifnum\gre@notes@phantomwrapper=1\relax
    \advance\gre@dimen@temp@five by \gre@dimen@staffheight\relax
  \else\ifnum\gre@notes@phantomwrapper=3\relax
    \advance\gre@dimen@temp@five by \gre@dimen@staffheight\relax
  \else\ifnum\gre@lines@phantomwrapper=1\relax
    \advance\gre@dimen@temp@five by \gre@dimen@staffheight\relax
  \else\ifnum\gre@lines@phantomwrapper=3\relax
    \advance\gre@dimen@temp@five by \gre@dimen@staffheight\relax
  \fi\fi\fi\fi\fi\fi
