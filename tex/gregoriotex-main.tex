...
\def\gre@typesettextabovelines#1#2{%
  ...
  \gre@dimen@temp@five=\dimexpr(\gre@dimen@staffheight %
    + \gre@space@dimen@spacebeneathtext %
    + \gre@space@dimen@spacelinestext)\relax%
  % If notes/lines are hidden with invisible, bring NABC/ALT closer to the lyrics line
  % phantom and vphantom preserve the height, so we don't adjust in that case
  \ifgre@shownotes\else
    \ifgre@showlines\else
      \ifnum\gre@notes@phantomwrapper=2\relax
        \ifnum\gre@lines@phantomwrapper=2\relax
          \advance\gre@dimen@temp@five by -\gre@dimen@staffheight\relax
        \else\ifnum\gre@lines@phantomwrapper=0\relax
          \advance\gre@dimen@temp@five by -\gre@dimen@staffheight\relax
        \fi\fi
      \else\ifnum\gre@notes@phantomwrapper=0\relax
        \ifnum\gre@lines@phantomwrapper=2\relax
          \advance\gre@dimen@temp@five by -\gre@dimen@staffheight\relax
        \else\ifnum\gre@lines@phantomwrapper=0\relax
          \advance\gre@dimen@temp@five by -\gre@dimen@staffheight\relax
