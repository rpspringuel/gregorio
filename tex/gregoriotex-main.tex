...
\def\gre@typesettextbelowlines#1{%
  ...
  \gre@dimen@temp@five=\dimexpr(\gre@space@dimen@spacebeneathtext
    + \gre@space@dimen@spacelinestext)\relax
  \leavevmode\raise\gre@dimen@temp@five\hbox attr \gre@attrid@part=8 to 0pt{#1\hss}%
  \gre@trace@end%
}%
...
\def\gresetlines#1{%
  ...
  % When lines become visible again, restore the saved values.
  \ifgre@showlines
    % visible: restore original dimensions if they were zeroed
    \ifgre@staffdimensions@zeroed
      \global\gre@dimen@stafflineheight=\gre@dimen@stafflineheight@saved\relax
      \global\gre@dimen@interstafflinespace=\gre@dimen@interstafflinespace@saved\relax
  ...
  \else
    \ifnum\gre@lines@phantomwrapper=1\relax
      % phantom: lines hidden but space preserved, restore if needed
      \ifgre@staffdimensions@zeroed
        \global\gre@dimen@stafflineheight=\gre@dimen@stafflineheight@saved\relax
        \global\gre@dimen@interstafflinespace=\gre@dimen@interstafflinespace@saved\relax
        \global\gre@staffdimensions@zeroedfalse
      ...
      \fi
    \else
      % invisible or hphantom: zero the dimensions
      \ifgre@staffdimensions@zeroed\else
        \global\gre@dimen@stafflineheight@saved=\gre@dimen@stafflineheight\relax
        \global\gre@dimen@interstafflinespace@saved=\gre@dimen@interstafflinespace\relax
        \global\gre@staffdimensions@zeroedtrue
      \fi
      \global\gre@dimen@stafflineheight=0pt\relax
      \global\gre@dimen@interstafflinespace=0pt\relax
      \gre@calculate@staffheight
      \gre@calculate@constantglyphraise
    \fi
  \fi
