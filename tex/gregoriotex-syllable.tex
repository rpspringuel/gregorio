...
\def\gre@notes@rendernabc#1{%
  \begingroup
    ...
    % Suppress bar glyphs while keeping spacing logic
...
\def\gre@spacingnoopglyph#1#2#3#4#5#6#7{%
  ...
  \global\gre@dimen@lastglyphwidth=\wd\gre@box@temp@width\relax
...
\def\gre@notes@rendernabc@withspacing#1{%
  \begingroup
    ...
    \let\GreGlyphHeights\gre@noopglyphheights
    % Suppress bar glyphs (same as \gre@notes@rendernabc)
    \def\GreInDivisioMinimis##1##2##3{}%
    \def\GreDivisioMinimis##1##2##3{}%
    \def\GreInDivisioMinimisHigh##1##2##3{}%
    \def\GreDivisioMinimisHigh##1##2##3{}%
