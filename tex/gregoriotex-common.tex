...
% #1 - the value to process (visible/invisible/phantom/hphantom/vphantom)
...
\def\gre@processvisibility#1#2#3#4#5{%
  \IfStrEqCase{#1}{%
    ...
    \gre@error{Unrecognized option "#1" for #5\MessageBreak Possible options are: 'visible', 'invisible', 'phantom', 'hphantom', and 'vphantom'}%
  ]%
}%
