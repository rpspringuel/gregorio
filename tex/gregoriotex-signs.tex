...
\gre@declarefileversion{gregoriotex-signs.tex}{6.2.0-beta2}% GREGORIO_VERSION
...
\def\gresetcustosalteration#1{%
  ...
  \gre@processvisibilitynophantom{#1}%
    {\gre@usecustosalterationtrue}%
  ...
  \ifgre@alteration@isvisible
    ...
    \else
      \ifnum\gre@notes@phantomwrapper>0\relax
        \gre@applynotesphantom{\gre@notes@phantomwrapper}{\gre@alteration@visible{#1}{\gre@alteration@type}{#3}{#4}{#5}{#6}}%
      \else
...
\def\gre@alteration@visible#1#2#3#4#5#6{%
  ...
  \setbox\gre@box@temp@width=\hbox
    ...
    {\ifgre@notes@invisrender
      \phantom{\gre@pointandclick{\gre@alteration@char}{#6}}%
    \else
  ...
  \ifgre@hidealtlines %
    \ifgre@notes@invisrender
      \phantom{\gre@fillhole{\gre@alteration@hole}{0}}%
    \else
