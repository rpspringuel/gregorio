...
\newif\ifgre@showclef%
\gre@showcleftrue
\newcount\gre@clef@phantomwrapper%
\gre@clef@phantomwrapper=0\relax%
...
\def\GreSetLinesClef#1#2#3#4#5#6#7{%
  ...
  \gre@localleftbox{%
    ...
    \ifgre@showclef%
      ...
      \ifnum\gre@clef@phantomwrapper>0\relax
        \hbox{\gre@applyphantomwrapper{\gre@clef@phantomwrapper}{\gre@typeclef{#1}{#2}{0}{#3}{#4}{#5}{#6}{#7}\gre@hskip\gre@skip@temp@four}}%
      \else
...
\def\GreSetInitialClef#1#2#3#4#5#6#7{%
  ...
  \ifgre@showclef%
    \ifnum\gre@count@initiallines=1\relax %
      \ifnum#7=1\relax %
        \ifnum\gre@clef@phantomwrapper>0\relax
          \gre@applyphantomwrapper{\gre@clef@phantomwrapper}{\gre@typeclef{#1}{#2}{0}{1}{#3}{#4}{#5}{#6}}%
        \else
          \gre@typeclef{#1}{#2}{0}{1}{#3}{#4}{#5}{#6}%
        \fi
      \else %
        \ifnum\gre@clef@phantomwrapper>0\relax
          \gre@applyphantomwrapper{\gre@clef@phantomwrapper}{\gre@typeclef{#1}{#2}{0}{2}{#3}{#4}{#5}{#6}}%
        \else
...
\newcount\gre@custosalteration@phantomwrapper%
\gre@custosalteration@phantomwrapper=0\relax%
\def\gresetcustosalteration#1{%
  \gre@trace{gresetcustosalteration{#1}}%
  \gre@processvisibility{#1}%
    {\gre@usecustosalterationtrue}%
    {\gre@usecustosalterationfalse}%
    {\gre@custosalteration@phantomwrapper}%
    {\protect\gresetcustosalteration}%
  \gre@trace@end%
}%
...
\newcount\gre@dottedbarlines@phantomwrapper%
\gre@dottedbarlines@phantomwrapper=0\relax%
\def\gresetlinesbehinddottedbar#1{%
  \gre@trace{gresetlinesbehinddottedbar{#1}}%
  \gre@processvisibility{#1}%
    {\gre@hidedottedbarlinesfalse}%
    {\gre@hidedottedbarlinestrue}%
    {\gre@dottedbarlines@phantomwrapper}%
    {\protect\gresetlinesbehinddottedbar}%
  \gre@trace@end%
}%
...
% macro for manipulating above flag
\newcount\gre@pclines@phantomwrapper%
\gre@pclines@phantomwrapper=0\relax%
\def\gresetlinesbehindpunctumcavum#1{%
  \gre@trace{gresetlinesbehindpunctumcavum{#1}}%
  \gre@processvisibility{#1}%
    {\gre@hidepclinesfalse}%
    {\gre@hidepclinestrue}%
    {\gre@pclines@phantomwrapper}%
    {\protect\gresetlinesbehindpunctumcavum}%
  \gre@trace@end%
}%
...
% macro for manipulating above flag
\newcount\gre@altlines@phantomwrapper%
\gre@altlines@phantomwrapper=0\relax%
\def\gresetlinesbehindalteration#1{%
  \gre@trace{gresetlinesbehindalteration{#1}}%
  \gre@processvisibility{#1}%
    {\gre@hidealtlinesfalse}%
    {\gre@hidealtlinestrue}%
    {\gre@altlines@phantomwrapper}%
    {\protect\gresetlinesbehindalteration}%
  \gre@trace@end%
}%
