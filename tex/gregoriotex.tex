...
% 		[2026/03/24 v6.2.0-beta2 GregorioTeX system.]% PARSE_VERSION_DATE_LTX
...
\def\gre@style@abovelinesnabc{\begingroup}%
\def\endgre@style@abovelinesnabc{\endgroup}%

\def\gre@style@belowlinesnabc{\begingroup}%
\def\endgre@style@belowlinesnabc{\endgroup}%
