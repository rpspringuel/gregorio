...
\gre@declarefileversion{gregoriotex-spaces.tex}{6.2.0}% GREGORIO_VERSION
...
\def\gre@calculate@stafflineheight{%
  ...
  \global\gre@dimen@stafflineheight@saved=\dimexpr(\gre@dimen@stafflinethicknessbase * \gre@stafflinefactor)\relax %
...
\def\gre@calculate@interstafflinespace{%
  ...
  \global\gre@dimen@interstafflinespace@saved=\dimexpr((\gre@dimen@interstafflinedistancebase + \gre@dimen@stafflinethicknessbase) * \gre@factor - \gre@dimen@stafflinethicknessbase * \gre@stafflinefactor)\relax%
  \ifgre@staffdimensions@zeroed
...
\def\gre@calculate@staffheight{%
  ...
  \global\gre@dimen@staffheight@saved = \dimexpr %
    \gre@count@stafflines\gre@dimen@stafflineheight@saved %
    + \gre@count@stafflines\gre@dimen@interstafflinespace@saved %
    - \gre@dimen@interstafflinespace@saved\relax%
  \ifgre@staffdimensions@zeroed
    \global\gre@dimen@staffheight = 0pt\relax%
  \else
    \global\gre@dimen@staffheight = \gre@dimen@staffheight@saved\relax%
  \fi
  \relax %
  \gre@trace@end%
}%
...
\def\gre@calculate@annotationtrueraise{%
  ...
  %% Use staffheight@saved so the annotation keeps its normal vertical
  %% position even when staff dimensions are zeroed (lines hphantom/invisible).
  \global\advance\gre@dimen@annotationtrueraise by %
    \dimexpr(\gre@dimen@staffheight@saved %
      + \gre@space@dimen@spacebeneathtext %
...
\def\grechangenextscorelinedim#1#2#3#4{%
  \IfStrEqCase{#2}{{abovelinestextheight}{}{abovelinestextraise}{}{abovelinesnabcheight}{}{abovelinesnabcraise}{}{spaceabovelines}{}{belowlinesnabcheight}{}{spacelinestext}{}{noteadditionalspacelinestext}{}{translationheight}{}{spacebeneathtext}{}}[%
    \gre@error{Unrecognized option "#2" for \protect\grechangenextscorelinedim\MessageBreak Possible options are: 'spaceabovelines', 'abovelinestextheight', 'abovelinestextraise', 'abovelinesnabcheight', 'abovelinesnabcraise', 'belowlinesnabcheight', 'spacelinestext', 'noteadditionalspacelinestext', 'translationheight', 'spacebeneathtext'}%
  ]%
  {\grechangedim{#2}{#3}{#4}%
...
\def\gre@changedimenfactor#1#2{%
  ...
  \fi%
  \ifgre@scale@bar@dominican@standalone@text%
  ...
  \fi%
  \ifgre@scale@bar@dominican@standalone@notext%
  ...
  \fi%
  \ifgre@scale@abovelinesnabcraise%
    \gre@changeonedimenfactor{abovelinesnabcraise}{#1}{#2}%
  \fi%
  \ifgre@scale@abovelinesnabcheight%
    \gre@changeonedimenfactor{abovelinesnabcheight}{#1}{#2}%
  \fi%
  \ifgre@scale@spaceabovelines%
    \gre@changeonedimenfactor{spaceabovelines}{#1}{#2}%
  \fi%
  \ifgre@scale@belowlinesnabcheight%
    \gre@changeonedimenfactor{belowlinesnabcheight}{#1}{#2}%
  \fi%
  ...
  \ifgre@scale@moraadjustmentbar%
    \gre@changeonedimenfactor{moraadjustmentbar}{#1}{#2}%
  \fi%
